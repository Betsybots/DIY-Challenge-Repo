...
# ─────────────────────────────────────────────────────────────────────────────
SVG_COURSE_MAP = """
<svg viewBox="0 0 820 520" xmlns="http://www.w3.org/2000/svg" font-family="Inter,sans-serif" font-size="9">
  <defs>
    <marker id="arr" markerWidth="8" markerHeight="8" refX="6" refY="3" orient="auto">
  ...
  <rect width="820" height="520" fill="#0f172a" rx="8"/>
  <text x="410" y="20" text-anchor="middle" fill="#475569" font-size="9" letter-spacing="1">COURSE ROUTE — SEQUENTIAL ZONE MAP  (approximate, not to scale)  ↺ counterclockwise</text>

  <!-- ══════════════════════════════════════════════════════════ -->
  <!-- BOTTOM ROW: START/FINISH (center) · going LEFT first      -->
  <!-- ══════════════════════════════════════════════════════════ -->

  <!-- ① START / FINISH — bottom center -->
  <rect x="310" y="430" width="150" height="55" fill="#1e293b" stroke="#22c55e" stroke-width="1.5" rx="4"/>
  <text x="385" y="450" text-anchor="middle" fill="#22c55e" font-weight="700" font-size="10">① START / FINISH</text>
  <text x="385" y="464" text-anchor="middle" fill="#94a3b8">32" wide · flat straight</text>
  <text x="385" y="477" text-anchor="middle" fill="#22c55e" font-size="8">NORMAL_NAV</text>

  <!-- arrow ← from START toward Ramp -->
  <line x1="310" y1="457" x2="215" y2="457" stroke="#64748b" stroke-width="1.5" marker-end="url(#arr)"/>
  <text x="262" y="450" text-anchor="middle" fill="#475569" font-size="7.5">← go left first</text>

  <!-- ② RAMP / HELIX — bottom left -->
  <rect x="30" y="430" width="185" height="55" fill="#1c1917" stroke="#eab308" stroke-width="1.5" rx="4"/>
  <text x="122" y="450" text-anchor="middle" fill="#fde68a" font-weight="700" font-size="10">② RAMP / HELIX</text>
  <text x="122" y="464" text-anchor="middle" fill="#94a3b8">4' radius · 11% grade · 32"</text>
  <text x="122" y="477" text-anchor="middle" fill="#eab308" font-size="8">SLOW_NAV · IMU pitch + roll</text>

  <!-- arrow ↑ from Ramp to Tunnel -->
  <line x1="75" y1="430" x2="75" y2="390" stroke="#64748b" stroke-width="1.5" marker-end="url(#arr)"/>

  <!-- ③ TUNNEL — left side lower -->
  <rect x="30" y="330" width="185" height="60" fill="#450a0a" stroke="#ef4444" stroke-width="1.5" rx="4"/>
  <text x="122" y="351" text-anchor="middle" fill="#fca5a5" font-weight="700" font-size="10">③ TUNNEL</text>
  <text x="122" y="365" text-anchor="middle" fill="#94a3b8">32" wide · 6' long · foil-lined foam</text>
  <text x="122" y="379" text-anchor="middle" fill="#ef4444" font-size="8">BLIND_DRIVE ⚡  lidar + RF dead</text>

  <!-- arrow ↑ from Tunnel to Narrow -->
  <line x1="75" y1="330" x2="75" y2="280" stroke="#64748b" stroke-width="1.5" marker-end="url(#arr)"/>

  <!-- ④ NARROW — left side upper -->
  <rect x="30" y="200" width="185" height="80" fill="#1a1a1a" stroke="#84cc16" stroke-width="1.5" rx="4"/>
  <text x="122" y="220" text-anchor="middle" fill="#bef264" font-weight="700" font-size="10">④ NARROW SECTION</text>
  <text x="122" y="234" text-anchor="middle" fill="#94a3b8">20" wide · curved path</text>
  <text x="122" y="248" text-anchor="middle" fill="#84cc16" font-size="8">SLOW_NAV · &lt;4cm lateral accuracy</text>
  <text x="122" y="262" text-anchor="middle" fill="#64748b" font-size="8">NDT re-localise check at entry</text>

  <!-- arrow → from Narrow across top to Gravel -->
  <line x1="215" y1="215" x2="255" y2="215" stroke="#64748b" stroke-width="1.5" marker-end="url(#arr)"/>

  <!-- ══════════════════════════════════════════════════════════ -->
  <!-- TOP ROW: Narrow → Gravel → Bank  (left to right)          -->
  <!-- ══════════════════════════════════════════════════════════ -->

  <!-- ⑤ GRAVEL + RAMPS — top center -->
  <rect x="255" y="170" width="230" height="75" fill="#1c1917" stroke="#eab308" stroke-width="1.5" rx="4"/>
  <text x="370" y="191" text-anchor="middle" fill="#fde68a" font-weight="700" font-size="10">⑤ GRAVEL + RAMPS</text>
  <text x="370" y="205" text-anchor="middle" fill="#94a3b8">4×8 gravel box · 1.5" deep pea gravel</text>
  <text x="370" y="218" text-anchor="middle" fill="#94a3b8">2" ramp down + up · 48" wide</text>
  <text x="370" y="231" text-anchor="middle" fill="#eab308" font-size="8">SLOW_NAV · 0.3 m/s · IMU pitch detect</text>

  <!-- arrow → to Bank -->
  <line x1="485" y1="207" x2="525" y2="207" stroke="#64748b" stroke-width="1.5" marker-end="url(#arr)"/>

  <!-- ⑥ BANK — top right -->
  <rect x="525" y="170" width="145" height="75" fill="#1a1a2e" stroke="#6366f1" stroke-width="1.5" rx="4"/>
  <text x="597" y="191" text-anchor="middle" fill="#a5b4fc" font-weight="700" font-size="10">⑥ BANK SECTION</text>
  <text x="597" y="205" text-anchor="middle" fill="#94a3b8">48"×128" inclined plane</text>
  <text x="597" y="219" text-anchor="middle" fill="#94a3b8">8.5° lateral tilt</text>
  <text x="597" y="233" text-anchor="middle" fill="#6366f1" font-size="8">SLOW_NAV</text>

  <!-- arrow ↓ Bank → Pothole -->
  <line x1="700" y1="207" x2="760" y2="207" stroke="#64748b" stroke-width="1.5"/>
  <line x1="760" y1="207" x2="760" y2="295" stroke="#64748b" stroke-width="1.5" marker-end="url(#arr)"/>

  <!-- ══════════════════════════════════════════════════════════ -->
  <!-- RIGHT COLUMN going DOWN: Pothole → Obstacle → Hoop        -->
  <!-- ══════════════════════════════════════════════════════════ -->

  <!-- ⑦ POTHOLE / WIDE — right upper -->
  <rect x="570" y="295" width="220" height="55" fill="#1a1a1a" stroke="#94a3b8" stroke-width="1" rx="4" stroke-dasharray="4,2"/>
  <text x="680" y="316" text-anchor="middle" fill="#94a3b8" font-weight="700" font-size="10">⑦ POTHOLE / WIDE SECTION</text>
  <text x="680" y="330" text-anchor="middle" fill="#64748b">0.75" bumps · 11'×26' open area</text>
  <text x="680" y="343" text-anchor="middle" fill="#94a3b8" font-size="8">NORMAL_NAV</text>

  <!-- arrow ↓ -->
  <line x1="680" y1="350" x2="680" y2="385" stroke="#64748b" stroke-width="1.5" marker-end="url(#arr)"/>

  <!-- ⑧ OBSTACLE (buckets) — right center -->
  <rect x="525" y="385" width="265" height="80" fill="#1c1917" stroke="#f97316" stroke-width="1.5" rx="4"/>
  <text x="657" y="404" text-anchor="middle" fill="#fdba74" font-weight="700" font-size="10">⑧ OBSTACLE SECTION</text>
  <text x="657" y="418" text-anchor="middle" fill="#94a3b8">2–9 × 5-gal buckets (randomly placed)</text>
  <circle cx="590" cy="445" r="10" fill="#292524" stroke="#f97316" stroke-width="1" stroke-dasharray="3,2"/>
  <circle cx="625" cy="438" r="10" fill="#292524" stroke="#f97316" stroke-width="1" stroke-dasharray="3,2"/>
  <circle cx="660" cy="450" r="10" fill="#292524" stroke="#f97316" stroke-width="1" stroke-dasharray="3,2"/>
  <circle cx="700" cy="440" r="10" fill="#292524" stroke="#f97316" stroke-width="1" stroke-dasharray="3,2"/>
  <text x="657" y="460" text-anchor="middle" fill="#f97316" font-size="8">NAVIGATE_AROUND</text>

  <!-- arrow ↓ Obstacle → Hoop -->
  <line x1="657" y1="465" x2="657" y2="488" stroke="#64748b" stroke-width="1.5"/>
  <line x1="657" y1="488" x2="760" y2="488" stroke="#64748b" stroke-width="1.5"/>
  <line x1="760" y1="488" x2="760" y2="505" stroke="#64748b" stroke-width="0"/>
  <!-- label -->

  <!-- ══════════════════════════════════════════════════════════ -->
  <!-- BOTTOM RIGHT → back to finish: Hoop → Car Wash → FINISH   -->
  <!-- ══════════════════════════════════════════════════════════ -->

  <!-- connecting line obstacle → hoop row -->
  <line x1="525" y1="440" x2="495" y2="440" stroke="#64748b" stroke-width="1.5" marker-end="url(#arr)"/>

  <!-- ⑨ HOOP SECTION — bottom center-right -->
  <rect x="310" y="340" width="185" height="55" fill="#1e1b4b" stroke="#a855f7" stroke-width="1.5" rx="4"/>
  <text x="402" y="360" text-anchor="middle" fill="#c4b5fd" font-weight="700" font-size="10">⑨ HOOP SECTION</text>
  <text x="402" y="374" text-anchor="middle" fill="#94a3b8">hoops at random positions · 36" wide</text>
  <text x="402" y="386" text-anchor="middle" fill="#a855f7" font-size="8">NORMAL_NAV</text>

  <!-- arrow ← Hoop → Car Wash -->
  <line x1="310" y1="367" x2="265" y2="367" stroke="#64748b" stroke-width="1.5" marker-end="url(#arr)"/>

  <!-- ⑩ CAR WASH — bottom center-left -->
  <rect x="80" y="340" width="185" height="55" fill="#172554" stroke="#3b82f6" stroke-width="1.5" rx="4"/>
  <text x="172" y="360" text-anchor="middle" fill="#93c5fd" font-weight="700" font-size="10">⑩ CAR WASH</text>
  <text x="172" y="374" text-anchor="middle" fill="#64748b">densely hanging ribbons · 48"</text>
  <text x="172" y="386" text-anchor="middle" fill="#ef4444" font-size="8">PUSH_THROUGH ⚠ obstacle layer OFF</text>

  <!-- arrow → Car Wash → FINISH -->
  <line x1="265" y1="430" x2="265" y2="395" stroke="#64748b" stroke-width="1.5"/>
  <line x1="265" y1="430" x2="310" y2="430" stroke="#64748b" stroke-width="1.5" marker-end="url(#arr)"/>
  <line x1="172" y1="395" x2="172" y2="430" stroke="#64748b" stroke-width="1.5"/>
  <line x1="172" y1="430" x2="265" y2="430" stroke="#64748b" stroke-width="0"/>
  <!-- car wash down to finish row -->
  <line x1="172" y1="395" x2="172" y2="430" stroke="#64748b" stroke-width="1.5"/>
  <line x1="172" y1="430" x2="310" y2="430" stroke="#64748b" stroke-width="1.5" marker-end="url(#arr)"/>

  <!-- ── LEGEND ── -->
  <rect x="30" y="100" width="10" height="10" fill="#450a0a" stroke="#ef4444" stroke-width="1" rx="1"/>
  <text x="44" y="109" fill="#94a3b8">BLIND_DRIVE</text>
  <rect x="30" y="116" width="10" height="10" fill="#1e293b" stroke="#22c55e" stroke-width="1" rx="1"/>
  <text x="44" y="125" fill="#94a3b8">NORMAL_NAV</text>
  <rect x="30" y="132" width="10" height="10" fill="#1c1917" stroke="#eab308" stroke-width="1" rx="1"/>
  <text x="44" y="141" fill="#94a3b8">SLOW_NAV</text>
  <rect x="140" y="100" width="10" height="10" fill="#1c1917" stroke="#f97316" stroke-width="1" rx="1"/>
  <text x="154" y="109" fill="#94a3b8">NAVIGATE_AROUND</text>
  <rect x="140" y="116" width="10" height="10" fill="#172554" stroke="#3b82f6" stroke-width="1" rx="1"/>
  <text x="154" y="125" fill="#94a3b8">PUSH_THROUGH</text>
</svg>
"""
