...
SVG_STATE_MACHINE = None  # using Graphviz above
...
# ─────────────────────────────────────────────────────────────────────────────
SVG_COURSE_MAP = """
<svg viewBox="0 0 820 390" xmlns="http://www.w3.org/2000/svg" font-family="Inter,sans-serif" font-size="9">
  <defs>
  ...
  <rect width="820" height="390" fill="#0f172a" rx="8"/>
  <text x="410" y="18" text-anchor="middle" fill="#475569" font-size="8.5" letter-spacing="0.8">COURSE ZONE SEQUENCE  ·  counterclockwise  ·  approximate order, not to scale</text>

  <!-- ══ ROW 1 → left to right ══ -->

  <!-- ① START -->
  <rect x="20" y="30" width="175" height="65" fill="#1e293b" stroke="#22c55e" stroke-width="1.5" rx="4"/>
  <text x="107" y="51" text-anchor="middle" fill="#22c55e" font-weight="700" font-size="10">① START</text>
  <text x="107" y="66" text-anchor="middle" fill="#94a3b8">32" wide straight</text>
  <text x="107" y="80" text-anchor="middle" fill="#22c55e" font-size="8">NORMAL_NAV</text>
  <line x1="195" y1="62" x2="210" y2="62" stroke="#64748b" stroke-width="1.5" marker-end="url(#arr)"/>

  <!-- ② RAMP + 270° HELIX LOOP -->
  <rect x="210" y="30" width="185" height="65" fill="#1c1917" stroke="#eab308" stroke-width="1.5" rx="4"/>
  <text x="302" y="51" text-anchor="middle" fill="#fde68a" font-weight="700" font-size="10">② RAMP + 270° HELIX</text>
  <text x="302" y="65" text-anchor="middle" fill="#94a3b8">ramp up · 270° loop · 4' radius · 11% grade</text>
  <text x="302" y="79" text-anchor="middle" fill="#eab308" font-size="8">SLOW_NAV · IMU pitch + roll</text>
  <line x1="395" y1="62" x2="410" y2="62" stroke="#64748b" stroke-width="1.5" marker-end="url(#arr)"/>

  <!-- ③ FLAT BRIDGE + TUNNEL -->
  <rect x="410" y="30" width="185" height="65" fill="#450a0a" stroke="#ef4444" stroke-width="1.5" rx="4"/>
  <text x="502" y="51" text-anchor="middle" fill="#fca5a5" font-weight="700" font-size="10">③ FLAT BRIDGE + TUNNEL</text>
  <text x="502" y="65" text-anchor="middle" fill="#94a3b8">bridge approach · 32" wide · 6' tunnel</text>
  <text x="502" y="79" text-anchor="middle" fill="#ef4444" font-size="8">BLIND_DRIVE ⚡  lidar + RF dead</text>
  <line x1="595" y1="62" x2="610" y2="62" stroke="#64748b" stroke-width="1.5" marker-end="url(#arr)"/>

  <!-- ④ WIDE → NARROW STRAIGHT -->
  <rect x="610" y="30" width="185" height="65" fill="#1a1a1a" stroke="#84cc16" stroke-width="1.5" rx="4"/>
  <text x="702" y="49" text-anchor="middle" fill="#bef264" font-weight="700" font-size="10">④ WIDE → NARROW</text>
  <text x="702" y="63" text-anchor="middle" fill="#94a3b8">wide straight narrows to 20"</text>
  <text x="702" y="77" text-anchor="middle" fill="#84cc16" font-size="8">SLOW_NAV · &lt;4cm lateral accuracy</text>

  <!-- right connector ↓ -->
  <line x1="795" y1="95" x2="795" y2="148" stroke="#64748b" stroke-width="1.5" marker-end="url(#arr)"/>

  <!-- ══ ROW 2 ← right to left ══ -->

  <!-- ⑤ GRAVEL SECTION -->
  <rect x="610" y="148" width="185" height="65" fill="#1c1917" stroke="#eab308" stroke-width="1.5" rx="4"/>
  <text x="702" y="168" text-anchor="middle" fill="#fde68a" font-weight="700" font-size="10">⑤ GRAVEL SECTION</text>
  <text x="702" y="182" text-anchor="middle" fill="#94a3b8">4×8 gravel box · 1.5" deep · 48" wide</text>
  <text x="702" y="196" text-anchor="middle" fill="#eab308" font-size="8">SLOW_NAV · 0.3 m/s</text>
  <line x1="610" y1="180" x2="595" y2="180" stroke="#64748b" stroke-width="1.5" marker-end="url(#arr)"/>

  <!-- ⑥ FLAT SECTIONS + 180° TURN -->
  <rect x="410" y="148" width="185" height="65" fill="#1e293b" stroke="#475569" stroke-width="1.2" rx="4"/>
  <text x="502" y="168" text-anchor="middle" fill="#94a3b8" font-weight="700" font-size="10">⑥ FLAT + 180° TURN</text>
  <text x="502" y="182" text-anchor="middle" fill="#64748b">flat run · 180° turn · flat run</text>
  <text x="502" y="196" text-anchor="middle" fill="#94a3b8" font-size="8">NORMAL_NAV</text>
  <line x1="410" y1="180" x2="395" y2="180" stroke="#64748b" stroke-width="1.5" marker-end="url(#arr)"/>

  <!-- ⑦ POTHOLE SECTION -->
  <rect x="210" y="148" width="185" height="65" fill="#1a1a1a" stroke="#94a3b8" stroke-width="1" rx="4" stroke-dasharray="4,2"/>
  <text x="302" y="168" text-anchor="middle" fill="#94a3b8" font-weight="700" font-size="10">⑦ POTHOLE SECTION</text>
  <text x="302" y="182" text-anchor="middle" fill="#64748b">0.75" bumps · 11'×26' open area</text>
  <text x="302" y="196" text-anchor="middle" fill="#94a3b8" font-size="8">NORMAL_NAV</text>
  <line x1="210" y1="180" x2="195" y2="180" stroke="#64748b" stroke-width="1.5" marker-end="url(#arr)"/>

  <!-- ⑧ WIDE SECTION — haybales at edges -->
  <rect x="20" y="148" width="175" height="65" fill="#1c1917" stroke="#f97316" stroke-width="1.2" rx="4"/>
  <text x="107" y="167" text-anchor="middle" fill="#fdba74" font-weight="700" font-size="10">⑧ WIDE SECTION</text>
  <text x="107" y="181" text-anchor="middle" fill="#94a3b8">haybales along edges (changeable)</text>
  <text x="107" y="195" text-anchor="middle" fill="#f97316" font-size="8">NORMAL_NAV · live costmap critical</text>

  <!-- left connector ↓ -->
  <line x1="35" y1="213" x2="35" y2="268" stroke="#64748b" stroke-width="1.5" marker-end="url(#arr)"/>

  <!-- ══ ROW 3 → left to right ══ -->

  <!-- ⑨ BUCKET OBSTACLES -->
  <rect x="20" y="268" width="175" height="65" fill="#1c1917" stroke="#f97316" stroke-width="1.5" rx="4"/>
  <text x="107" y="288" text-anchor="middle" fill="#fdba74" font-weight="700" font-size="10">⑨ BUCKET OBSTACLES</text>
  <text x="107" y="302" text-anchor="middle" fill="#94a3b8">2–9 × 5-gal buckets (random)</text>
  <text x="107" y="316" text-anchor="middle" fill="#f97316" font-size="8">NAVIGATE_AROUND</text>
  <line x1="195" y1="300" x2="210" y2="300" stroke="#64748b" stroke-width="1.5" marker-end="url(#arr)"/>

  <!-- ⑩ HOOP SECTION -->
  <rect x="210" y="268" width="185" height="65" fill="#1e1b4b" stroke="#a855f7" stroke-width="1.5" rx="4"/>
  <text x="302" y="288" text-anchor="middle" fill="#c4b5fd" font-weight="700" font-size="10">⑩ HOOP SECTION</text>
  <text x="302" y="302" text-anchor="middle" fill="#94a3b8">random hoop positions · 36" wide</text>
  <text x="302" y="316" text-anchor="middle" fill="#a855f7" font-size="8">NORMAL_NAV</text>
  <line x1="395" y1="300" x2="410" y2="300" stroke="#64748b" stroke-width="1.5" marker-end="url(#arr)"/>

  <!-- ⑪ BANK — 180° SLANTED TURN -->
  <rect x="410" y="268" width="185" height="65" fill="#1a1a2e" stroke="#6366f1" stroke-width="1.5" rx="4"/>
  <text x="502" y="288" text-anchor="middle" fill="#a5b4fc" font-weight="700" font-size="10">⑪ BANK — 180° SLANTED</text>
  <text x="502" y="302" text-anchor="middle" fill="#94a3b8">inclined plane · 8.5° lateral tilt</text>
  <text x="502" y="316" text-anchor="middle" fill="#6366f1" font-size="8">SLOW_NAV · lateral roll correction</text>
  <line x1="595" y1="300" x2="610" y2="300" stroke="#64748b" stroke-width="1.5" marker-end="url(#arr)"/>

  <!-- ⑫ CAR WASH + FINISH -->
  <rect x="610" y="268" width="185" height="65" fill="#172554" stroke="#3b82f6" stroke-width="1.5" rx="4"/>
  <text x="702" y="287" text-anchor="middle" fill="#93c5fd" font-weight="700" font-size="10">⑫ CAR WASH + FINISH</text>
  <text x="702" y="301" text-anchor="middle" fill="#64748b">hanging ribbons · 48" wide</text>
  <text x="702" y="315" text-anchor="middle" fill="#ef4444" font-size="8">PUSH_THROUGH ⚠ costmap OFF</text>
  <text x="702" y="327" text-anchor="middle" fill="#22c55e" font-size="8">✓ FINISH LINE</text>

  <!-- LEGEND -->
  <rect x="20" y="362" width="8" height="8" fill="#450a0a" stroke="#ef4444" stroke-width="1" rx="1"/>
  <text x="32" y="370" fill="#94a3b8">BLIND_DRIVE</text>
  <rect x="120" y="362" width="8" height="8" fill="#1c1917" stroke="#eab308" stroke-width="1" rx="1"/>
  <text x="132" y="370" fill="#94a3b8">SLOW_NAV</text>
  <rect x="210" y="362" width="8" height="8" fill="#1c1917" stroke="#f97316" stroke-width="1" rx="1"/>
  <text x="222" y="370" fill="#94a3b8">NAVIGATE_AROUND</text>
  <rect x="340" y="362" width="8" height="8" fill="#172554" stroke="#3b82f6" stroke-width="1" rx="1"/>
  <text x="352" y="370" fill="#94a3b8">PUSH_THROUGH</text>
  <rect x="450" y="362" width="8" height="8" fill="#1e293b" stroke="#22c55e" stroke-width="1" rx="1"/>
  <text x="462" y="370" fill="#94a3b8">NORMAL_NAV</text>
</svg>
"""
...
<div class="page section pagebreak" id="s2">
  ...
  <p>
    ...
    using a factor graph — a statistical graph that links sensor measurements together so errors can be
    corrected globally. As the robot drives and revisits previously seen places, it performs
    <em>loop closure</em>: it recognises that it is back at a known location, then pulls the entire trajectory
    into alignment to remove accumulated drift. When we're happy with the map quality in RViz, we call the
  ...
  <p>
    ...
    It publishes directly into the <strong>TF tree</strong> — ROS 2's coordinate frame system that tracks
    the spatial relationship between every frame (map, odom, base_link) at all times — so Nav2 doesn't
    need to know anything about how it works.
  </p>
  <p>
  ...
  <div class="grid2">
    <div class="card">
      <div class="card-title"><span class="dot dot-orange"></span>EKF1 — Wheel + IMU Only, 100 Hz (ekf_wimu.yaml)</div>
      <p>Fuses dead-wheel encoder odometry (<code>/wheel_cmd_vel</code>) with IMU angular velocity
      (<code>/imu/data</code>) to produce <code>/wimu_odom</code> at 50–100 Hz. No lidar involved —
      this runs fast, fills the gaps between lidar updates, and keeps pose estimates smooth.
      It drifts slowly over time but is very accurate over short intervals.</p>
    </div>
    <div class="card">
      <div class="card-title"><span class="dot dot-green"></span>EKF2 — Wheel + IMU + Lidar, 50 Hz (ekf_local.yaml)</div>
      <p>Takes <code>/wimu_odom</code> (fast, smooth, drifts) and <code>/lidar_odometry</code>
      (FAST-LIO2, accurate, lower rate) and fuses them into <code>/odometry/filtered</code>.
      The result is both smooth and drift-corrected — MPPI gets 50 Hz smooth inputs, and every
      lidar scan pulls the estimate back to ground truth.</p>
    </div>
  </div>
</div>
...
<div class="page section pagebreak" id="s5">
  ...
  <p>
    ...
    Hybrid-A* is a path-finding algorithm that searches a grid while also accounting for the
    robot's heading and minimum turning radius — so paths are physically drivable, not just
    geometrically shortest.
    The MPPI (Model Predictive Path Integral) controller samples thousands of random trajectory
    rollouts forward in time and picks the one that best follows the path while avoiding obstacles.
    The full live costmap is active.
  </p>
  <p>
  ...
  <p>
    ...
    This is a known, fixed-length obstacle — we handle it with deliberate <em>dead reckoning</em>:
    estimating position purely from known starting point, wheel speed, and heading — no external
    sensor reference.
  </p>
  ...
  <div class="callout callout-crit">
    ...
    This is the highest-priority navigation feature to implement before Aug 31.
  </div>
...
global_costmap:
  ...
  <div class="callout callout-warn">
    ...
    the narrow zone, we need to consider temporarily reducing <code>inflation_radius</code> to 0.2m
    via a dynamic reconfigure call from the state machine.
  </div>
</div>
...
<div class="page section pagebreak" id="s7">
  ...
  <table>
    ...
    <tbody>
      <tr>
        ...
        <td>Hard deadline. Robot executes under its own control using odometry feedback. Uses existing motion_plan_executor. Needs hardware running. <strong>Team internal target: Jul 31.</strong></td>
        <td>Aug 14</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td>Required — robot is 16" wide in a 20" passage. Default 0.45m marks it impassable.</td>
        <td>Aug</td>
      </tr>
      <tr>
        <td><strong style="color:var(--green)">10</strong></td>
        <td><strong>E-stop safety review</strong></td>
        <td>Required by Sep 1 — heartbeat, assertion, clearing demonstration.</td>
        <td>Sep 1</td>
      </tr>
    </tbody>
  </table>
  ...
  <div class="callout callout-info">
    ...
    By Aug 14: hardware running, FAST-LIO2 publishing, motion_plan_demo passing (team internal target: Jul 31). That's the foundation.
    All development complete by Aug 31 — full September is reserved for testing and tuning on the actual course.
    Get the robot moving first; everything in this document builds on top of that.
  </div>
