...
#   src/robot_description/urdf/    Updated URDF with real extrinsic transforms
...
_deploy "src/robot_description/urdf/" "src/robot_description/urdf/" "URDF"
...
echo "  1. cd ~/ros2_ws"
echo "  2. colcon build --packages-select localization robot_description challenge_bringup"
