...
[![Build Status](https://github.com/at-wat/mcl_3dl/actions/workflows/test.yaml/badge.svg)](https://github.com/at-wat/mcl_3dl/actions/workflows/test.yaml)
...
This package targets ROS 2 Humble and defines its interfaces locally.
...
colcon build --packages-select mcl_3dl --cmake-args -DCMAKE_BUILD_TYPE=Release
```
...
# Running the demo
ros2 launch mcl_3dl test.launch.py
```
