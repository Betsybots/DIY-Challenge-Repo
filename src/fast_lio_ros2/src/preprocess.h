...
// the Hesai QT64 LiDAR.  Original upstream logic and structure
...
//   - Added Hesai QT64 lidar_type (ROS 2: 3), routed through
//     hesai_handler() using the standard PointCloud2 layout
