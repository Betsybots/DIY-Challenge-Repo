...
def generate_launch_description():
    ...
    challenge_bringup_dir = get_package_share_directory('challenge_bringup')

    namespace = LaunchConfiguration('namespace')
    # map_yaml_file = LaunchConfiguration('map_pgm')
    ...
    lifecycle_nodes = ['map_server', 'map_localizer']
    ...
    declare_params_file_cmd = DeclareLaunchArgument(
        'params_file',
        default_value=os.path.join(challenge_bringup_dir, 'config', 'nav2_params.yaml'),
    ...
    load_composable_nodes = LoadComposableNodes(
        ...
        composable_node_descriptions=[
            ...
            ComposableNode(
                package='map_localizer',
                plugin='map_localizer::LocalizerNode',
                name='map_localizer',
                parameters=[configured_params],
                remappings=remappings),
            ComposableNode(
